...
const variants: Record<ButtonVariant, string> = {
  ...
  outline: cn(
    'bg-transparent border-2 border-neutral-200 text-neutral-900 hover:bg-neutral-50 hover:border-neutral-300 dark:border-neutral-700 dark:text-text-secondary dark:hover:bg-neutral-800 dark:hover:text-white'
  ),
  ghost: cn(
    'bg-transparent text-neutral-700 hover:text-neutral-900 dark:text-text-secondary dark:hover:bg-neutral-800 dark:hover:text-white'
  ),
