        ...
        {images.length > 1 && (
          <>
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/80 dark:bg-black/50 hover:bg-white dark:hover:bg-black text-neutral-800 dark:text-text-secondary shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-200"
