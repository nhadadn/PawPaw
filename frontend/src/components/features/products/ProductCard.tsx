          ...
          <div className="absolute top-3 left-3 z-10 flex flex-col gap-2 transition-opacity duration-300 opacity-100 lg:opacity-0 lg:group-hover:opacity-100">
            ...
            {showQuickView && (
              <button
                ...
                className="p-2.5 rounded-full bg-white/90 dark:bg-black/90 shadow-sm backdrop-blur-sm text-neutral-600 transition-all duration-200 hover:scale-110 active:scale-95 border border-neutral-200/50 dark:border-white/20 hover:text-accent dark:text-text-secondary dark:hover:text-primary"
