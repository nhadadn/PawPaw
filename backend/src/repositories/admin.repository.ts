...
export class AdminRepository {
  ...
  async updateProduct(id: number, data: any, imageOrder?: { type: 'existing' | 'new', id?: string, index?: number }[], newImageUrls?: string[], stock?: number) {
  ...
  async getDashboardStats() {
      const [totalOrders, totalProducts, totalUsers, totalSales, recentOrdersRaw, lowStockCount] = await Promise.all([
          prisma.order.count(),
